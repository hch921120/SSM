							...
							<div class="form-group form-inline">
								<div class="btn-group">
									<button type="button" class="btn btn-default" title="新建"
										onclick='location.href="${pageContext.request.contextPath}/order/add"'>
				...
				<div class="box-footer">
					<div class="pull-left">
						<div class="form-group form-inline">
							...
							每页 <select class="form-control" onchange="gopage(this.value)">
							<option value="1" <c:if test="${pageInfo.pageSize==1}">selected="selected"</c:if>>1</option>
							<option value="3" <c:if test="${pageInfo.pageSize==3}">selected="selected"</c:if>>3</option>
							...
							<script>
								function gopage(size) {
									...
									location.href="/order/page?pageNum=1&pageSize="+size;
					...
					<div class="box-tools pull-right">
						<ul class="pagination">
							<li><a href="/order/page?pageSize=${pageInfo.pageSize}" aria-label="Previous">首页</a></li>
							<li><a href="/order/page?pageNum=${pageInfo.prePage}&pageSize=${pageInfo.pageSize}">上一页</a></li>

							<c:forEach items="${pageInfo.navigatepageNums}" var="page">

							<li><a href="/order/page?pageNum=${page}&pageSize=${pageInfo.pageSize}">${page}</a></li>

							</c:forEach>
							<li><a href="/order/page?pageNum=${pageInfo.nextPage}&pageSize=${pageInfo.pageSize}">下一页</a></li>
							<li><a href="/order/page?pageNum=${pageInfo.pages}&pageSize=${pageInfo.pageSize}" aria-label="Next">尾页</a></li>
						</ul>
					</div>
