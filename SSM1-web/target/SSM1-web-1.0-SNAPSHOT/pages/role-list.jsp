			...
			<!-- 内容头部 /-->
				...
				<div class="box box-primary">
					...
					<div class="box-footer">
							...
							<div class="form-group form-inline">
								...
								<script>
									function page(size) {
										...
										location.href="/role/list?pageNum=1&pageSize="+size;
									}
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li><a href="/role/list?pageNum=1&pageSize=${pageInfo.pageSize}" aria-label="Previous">首页</a></li>
								<li><a href="/role/list?pageNum=${pageInfo.prePage}&pageSize=${pageInfo.pageSize}">上一页</a></li>

								<c:forEach items="${pageInfo.navigatepageNums}" var="page">

									<li><a href="/role/list?pageNum=${page}&pageSize=${pageInfo.pageSize}">${page}</a></li>

								</c:forEach>



								<li><a href="/role/list?pageNum=${pageInfo.nextPage}&pageSize=${pageInfo.pageSize}">下一页</a></li>
								<li><a href="/role/list?pageNum=${pageInfo.pages}&pageSize=${pageInfo.pageSize}" aria-label="Next">尾页</a></li>
							</ul>
						</div>
